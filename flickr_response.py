...
print(photo.__contains__("Nature"))
print(photo.__contains__("Forrest"))

if photo.__contains__("Nature"):
    print("Nature is a tag!")

if photo.__contains__("Mountain"):
    print("Mountain is a tag!")

if photo.__contains__("Chris"):
    print("Chris is a tag")
else:
    print("Chris is not a tag!")
